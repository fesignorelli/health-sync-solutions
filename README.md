...
Esta landing page foi desenvolvida com **HTML5 e CSS3 puro**, sem frameworks, com foco em fidelidade ao design, responsividade e boas práticas de código.
...
| 9 | 📬 **CTA + Formulário** | Solicitação de demonstração |
...
```bash
# Clone o repositório
git clone https://github.com/seu-usuario/health-sync-solutions.git
...
- 📱 **Mobile** (≤ 900px) — colunas empilhadas, imagens redimensionadas, navegação adaptada
